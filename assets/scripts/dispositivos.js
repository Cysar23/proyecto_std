...
const actualizar_dispositivo = (id, actualizando) => db.collection('usuarios').doc(uid).collection('datos_dispositivos').doc(id).update(actualizando);
        ...
        var validation = Array.prototype.filter.call(forms, function(form) {
            form.addEventListener('submit', async(event) =>{
                if (form.checkValidity() === true) {
                    ...
                    const frecuencia_de_pastillas_2 = form_dispositivo["frecuencia_de_pastillas_2"].value;
                    const dia_inicio_pastilla_2 = form_dispositivo["dia_inicio_pastilla_2"].value;
                    const hora_inicio_pastilla_2 = form_dispositivo["hora_inicio_pastilla_2"].value;
                    ...
                    const frecuencia_de_pastillas_3 = form_dispositivo["frecuencia_de_pastillas_3"].value;
                    const dia_inicio_pastilla_3 = form_dispositivo["dia_inicio_pastilla_3"].value;
                    const hora_inicio_pastilla_3 = form_dispositivo["hora_inicio_pastilla_3"].value;
                   ...
                   if (!editStatus) {
                        ...
                        if (estado_mac == false)  {
                            let registrando_MAC = db.collection("usuarios").doc("registros_MAC");
                                            ...
                                            <div class="dropdown-menu-header-inner bg-success">
                                                <div class="menu-header-content">
                                                    <div>
                                                        ...
                                                        <h6 class="menu-header-subtitle">STD ID: [${dispositivos.mac_dispositivo}]</h6>
                                                    </div>
                                                                ...
                                                                <div class="widget-content-wrapper">
                                                                    ...
                                                                    <div class="widget-content-left flex2" style="margin-right: 5px;">
                                                                        ...
                                                                        <div class="widget-subheading opacity-10">
                                                                            <span > Pastillas: <b class="text-primary">${dispositivos.contenedor_1.pastilla}</b></span>
                                                                            <br>
                                                                            <div class="text-center">${dispositivos.contenedor_1.stock_1} de 10</div>
                                                                            <div class="mb-3 progress">
                                                                                <div class="progress-bar" role="progressbar" aria-valuenow="1" aria-valuemin="0" aria-valuemax="5" style="width: ${dispositivos.contenedor_1.stock_1}0%;"></div>
                                                                            </div>
                                                                    ...
                                                                    <div class="widget-content-right">
                                                                        <div class="btn-group-vertical" role="group" aria-label="Basic example">
                                                                            <button type="button" class="btn-transition btn btn-outline-success btn_abrir_dispositivo" data-id="${dispositivos.id}" value="1">Abrir</button>
                                                                            <button type="button" class="btn-transition btn btn-outline-success btn_rellenar" data-id="${dispositivos.id}" value="1">Rellenar</button>
                                                                            <button type="button" class="btn-transition btn btn-outline-success btn_vaciar" data-id="${dispositivos.id}" value="1">Vaciar</button>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="widget-content p-0">
                                                                <div class="widget-content-wrapper">
                                                                    ...
                                                                    <div class="widget-content-left flex2" style="margin-right: 5px;">
                                                                        ...
                                                                        <div class="widget-subheading opacity-10">
                                                                        <span > Pastillas: <b class="text-primary">${dispositivos.contenedor_2.pastilla_2}</b></span>
                                                                            <br>
                                                                            <div class="text-center">${dispositivos.contenedor_2.stock_2} de 10</div>
                                                                            <div class="mb-3 progress">
                                                                                <div class="progress-bar" role="progressbar" aria-valuenow="1" aria-valuemin="0" aria-valuemax="5" style="width: ${dispositivos.contenedor_2.stock_2}0%;"></div>
                                                                            </div>
                                                                    ...
                                                                    <div class="widget-content-right">
                                                                        <div class="btn-group-vertical" role="group" aria-label="Basic example">
                                                                            <button type="button" class="btn-transition btn btn-outline-success btn_abrir_dispositivo"  data-id="${dispositivos.id}" value="2">Abrir</button>
                                                                            <button type="button" class="btn-transition btn btn-outline-success btn_rellenar" data-id="${dispositivos.id}" value="2">Rellenar</button>
                                                                            <button type="button" class="btn-transition btn btn-outline-success btn_vaciar" data-id="${dispositivos.id}" value="2">Vaciar</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="widget-content p-0">
                                                                <div class="widget-content-wrapper">
                                                                    ...
                                                                    <div class="widget-content-left flex2" style="margin-right: 5px;">
                                                                        ...
                                                                        <div class="widget-subheading opacity-10">
                                                                        <span > Pastillas: <b class="text-primary">${dispositivos.contenedor_3.pastilla_3}</b></span>
                                                                            <br>
                                                                            <div class="text-center">${dispositivos.contenedor_3.stock_3} de 10</div>
                                                                            <div class="mb-3 progress">
                                                                                <div class="progress-bar" role="progressbar" aria-valuenow="1" aria-valuemin="0" aria-valuemax="5" style="width: ${dispositivos.contenedor_1.stock_3}0%;"></div>
                                                                            </div>
                                                                    ...
                                                                    <div class="widget-content-right">
                                                                        <div class="btn-group-vertical" role="group" aria-label="Basic example">
                                                                            <button type="button" class="btn-transition btn btn-outline-success btn_abrir_dispositivo" data-id="${dispositivos.id}" value="3">Abrir</button>
                                                                            <button type="button" class="btn-transition btn btn-outline-success btn_rellenar" data-id="${dispositivos.id}" value="3">Rellenar</button>
                                                                            <button type="button" class="btn-transition btn btn-outline-success btn_vaciar" data-id="${dispositivos.id}" value="3">Vaciar</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
...
const guardar_dispositivo = (numero_dispositivo, 
    idNombrePaciente, 
    paciente, 
    mac_dispositivo,
    contenedor_1,
...
const pas =  async() => {
    ...
    let registrando_PASTILLAS = db.collection('usuarios').doc(uid).collection('pastillas').doc('registros_pastillas');
    let agregando_sino_esta = await db.collection('usuarios').doc(uid).collection('pastillas').doc('registros_pastillas').get();
    ...
    const db_cons_pastillas =  await db.collection('usuarios').doc(uid).collection('pastillas').doc('registros_pastillas').get();
    console.log('PASTILLAS: ',db_cons_pastillas.data().PASTILLAS);
    let array_pastillas = db_cons_pastillas.data().PASTILLAS;

    document.getElementById("id_pastilla_1").innerHTML += `<option value="" disabled selected>Seleccione...</option> `;
    document.getElementById("id_pastilla_2").innerHTML += `<option value="" disabled selected>Seleccione...</option> `;
    document.getElementById("id_pastilla_3").innerHTML += `<option value="" disabled selected>Seleccione...</option> `;
...
checkbox_contenedor_2.addEventListener('click', function () {
    ...
    if (checkbox_contenedor_2.checked) {
        ...
        document.getElementById('frecuencia_de_pastillas_2').removeAttribute("disabled");
        document.getElementById('dia_inicio_pastilla_2').removeAttribute("disabled");
        document.getElementById('hora_inicio_pastilla_2').removeAttribute("disabled");
        ...
        document.getElementById('id_pastilla_2').setAttribute("disabled", "required");
        document.getElementById('frecuencia_de_pastillas_2').setAttribute("disabled", "required");
        document.getElementById('dia_inicio_pastilla_2').setAttribute("disabled", "required");
        document.getElementById('hora_inicio_pastilla_2').setAttribute("disabled", "required");
        document.getElementById('t_tratamiento_2').setAttribute("disabled", "required");
...
checkbox_contenedor_3.addEventListener('click', function () {
    ...
    if (checkbox_contenedor_3.checked) {
        ...
        document.getElementById('frecuencia_de_pastillas_3').removeAttribute("disabled");
        document.getElementById('dia_inicio_pastilla_3').removeAttribute("disabled");
        document.getElementById('hora_inicio_pastilla_3').removeAttribute("disabled");
        ...
        document.getElementById('id_pastilla_3').setAttribute("disabled", "required");
        document.getElementById('frecuencia_de_pastillas_3').setAttribute("disabled", "required");
        document.getElementById('dia_inicio_pastilla_3').setAttribute("disabled", "required");
        document.getElementById('hora_inicio_pastilla_3').setAttribute("disabled", "required");
        document.getElementById('t_tratamiento_3').setAttribute("disabled", "required");
...
async  function agregar_pastillas() {
    ...
    if (nombre_pastilla == '' || mg_pastillas =='') {
        ...
        const consultando_pastillas =  await db.collection('usuarios').doc(uid).collection('pastillas').doc('registros_pastillas').get();
                            console.log('PASTILLAS: ',consultando_pastillas.data().PASTILLAS);
                            let array_pastillas = consultando_pastillas.data().PASTILLAS;
                            array_pastillas.forEach(db_pastilla => {
                                console.log(db_pastilla.nombre_pastilla);

                                if (db_pastilla.nombre_pastilla == nombre_pastilla && db_pastilla.miligramos == mg_pastillas) {
